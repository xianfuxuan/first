...
public class Mirage {
    ...
    public Mirage(int x, int y, Bitmap bitmap) {
        this.id = UUID.randomUUID().toString();
        this.x = x;
        this.y = y;
        this.bitmap = bitmap;
    ...
    public Mirage(int x, int y, int r) {
        this.id = UUID.randomUUID().toString();
        this.x = x;
        this.y = y;
        this.r = r;
    ...
    public Mirage(int x, int y, int r, int color) {
        this.id = UUID.randomUUID().toString();
        this.x = x;
        this.y = y;
        this.r = r;
    ...
    public Mirage(int x, int y, int r, int color, int type) {
        this.x = x;
        this.y = y;
        this.r = r;
        this.color = color;
    ...
    public Mirage(String id, int x, int y, int r, int color) {
        this.id = id;
        this.x = x;
        this.y = y;
        this.r = r;
    ...
    public List<Mirage> die() {
        List<Mirage> balls = new ArrayList<>(4);
        Mirage ballRight = new Mirage(this.x - this.r / 2, y, this.r / 2, this.color, this.type);
        Mirage ballTop = new Mirage(this.x, y - this.r / 2, this.r / 2, this.color, this.type);
        Mirage ballLeft = new Mirage(this.x + this.r / 2, y, this.r / 2, this.color, this.type);
        Mirage ballDown = new Mirage(this.x, y + this.r / 2, this.r / 2, this.color, this.type);
        balls.add(ballRight);
        balls.add(ballTop);
        balls.add(ballLeft);
        balls.add(ballDown);
